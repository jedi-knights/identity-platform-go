...
// domain.PolicyRepository and domain.RoleRepository. It exists as the
// local/acceptance-test-time swap-in for the postgres adapter — same
// domain contracts, no server process required. Migrations are embedded
// at compile time and are SQLite-dialect equivalents of the postgres
// migrations, not shared SQL text (see
// migrations/000001_create_roles_and_policies.up.sql for the
