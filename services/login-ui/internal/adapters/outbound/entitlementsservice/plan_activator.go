...
// an apperror.
func (a *PlanActivator) ActivatePlan(ctx context.Context, req ports.ActivatePlanRequest) error {
	...
	if err != nil {
		return apperrors.Wrap(apperrors.ErrCodeInternal, "encoding activate-plan request", err)
	}
